...
class RabbitMqConnectorFactoryConfig {
    ...
    fun defineConnectorsFactory(connectionFactory: ConnectionFactory,
                                messageConverter: MessageConverter): boaentrega.gsl.support.eventsourcing.connectors.AbstractConnectorFactory {
        return boaentrega.gsl.support.eventsourcing.connectors.amqp.AmqpConnectorFactory(connectionFactory, messageConverter)
    }
}