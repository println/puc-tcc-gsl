package boaentrega.gsl.order.domain.partnership.web

import boaentrega.gsl.order.configuration.constants.ServiceNames
import boaentrega.gsl.order.domain.partnership.Partner
import boaentrega.gsl.order.domain.partnership.PartnerFilter
import boaentrega.gsl.order.domain.partnership.PartnerService
