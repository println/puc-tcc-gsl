package boaentrega.gsl.services.delivery.domain.delivery.web

import boaentrega.gsl.services.delivery.domain.delivery.Delivery
import boaentrega.gsl.services.delivery.domain.delivery.DeliveryFilter
import org.springframework.data.domain.Page
import org.springframework.data.domain.Pageable
import org.springframework.web.bind.annotation.*
import java.util.*

@RequestMapping("\${boaentrega.gsl.api.path.delivery:}")
@RestController
