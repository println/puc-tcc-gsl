package boaentrega.gsl.services.freight.domain.freight.web

import boaentrega.gsl.services.freight.domain.freight.Freight
import boaentrega.gsl.services.freight.domain.freight.FreightFilter
...
@RequestMapping("\${boaentrega.gsl.api.path.freight:}")
@RestController
